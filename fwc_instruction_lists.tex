...
mul\_hi\_s   & 12 & 2 & (src1 $\cdot$ src2) \textgreater\textgreater{} OS, signed (integer only). \\
mul\_hi\_u   & 13 & 2 & (src1 $\cdot$ src2) \textgreater\textgreater{}  OS, unsigned (integer only). \\
mul\_ex\_s   & 14 & 2 & Multiply even-numbered signed integer vector elements to double size result. \\
