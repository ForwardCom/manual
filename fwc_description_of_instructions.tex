...
\subsection{Combined ALU and branch instructions}
...
\subsubsection{add\_jump\_nzero}
\label{table:addJumpNzeroInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 16 & add\_jump\_nzero & integer \\ \hline
all & 17 & add\_jump\_zero & integer\\ \hline
\end{tabular}
\vspace{2mm}

Add two integer operands and jump if the result is non-zero.


\subsubsection{add\_jump\_neg}
\label{table:addJumpNegInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 18 & add\_jump\_neg & integer \\ \hline
all & 19 & add\_jump\_nneg & integer\\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{add\_jump\_pos}
\label{table:addJumpPosInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 20 & add\_jump\_pos & integer \\ \hline
all & 21 & add\_jump\_npos & integer\\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{add\_jump\_overfl}
\label{table:addJumpOverflInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 22 & add\_jump\_overfl & integer \\ \hline
all & 23 & add\_jump\_noverfl & integer\\ \hline
\end{tabular}
\vspace{2mm}

Add two signed integer operands and jump if the result overflows.

\subsubsection{add\_jump\_carry}
\label{table:addJumpCarryInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 24 & add\_jump\_carry & integer \\ \hline
all & 25 & add\_jump\_ncarry & integer\\ \hline
\end{tabular}
\vspace{2mm}

Add two unsigned integer operands and jump if the operation produces a carry.

\subsubsection{add\_jump}
\label{table:addJumpInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 57 & add\_jump & integer \\ \hline
\end{tabular}
\vspace{2mm}

Add two integer operands and jump unconditionally.

\subsubsection{increment\_jump\_above}
\label{table:addJumpInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 54 & increment\_jump\_above & integer \\ \hline
all & 55 & increment\_jump\_beloweq & integer \\ \hline
\end{tabular}
\vspace{2mm}
...
The result will wrap around from INT\_MAX to INT\_MIN in case of overflow, and jump only if the second source operand is also INT\_MAX.
\vspace{2mm}
...
\subsubsection{sub\_jump\_nzero}
\label{table:subJumpNzeroInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
1.4, 2.7.0 &  0 & sub\_jump\_nzero & integer \\ \hline
1.4, 2.7.0 &  1 & sub\_jump\_zero  & integer\\ \hline
\end{tabular}
\vspace{2mm}

Subtract two integer operands and jump if the result is non-zero.
\vspace{2mm}

Immedate constants are not allowed, and the corresponding format is used for other purposes.
If a constant operand is needed then change the sign of the operand and use add\_jump\_nzero. 

\subsubsection{sub\_jump\_neg}
\label{table:subJumpNegInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
1.4, 2.7.0 &  2 & sub\_jump\_neg & integer \\ \hline
1.4, 2.7.0 &  3 & sub\_jump\_nneg & integer\\ \hline
\end{tabular}
\vspace{2mm}
...
Immedate constants are not allowed, and the corresponding format is used for other purposes.
If a constant operand is needed then change the sign of the operand and use add\_jump\_neg. 

\subsubsection{sub\_jump\_pos}
\label{table:subJumpPosInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
1.4, 2.7.0 &  4 & sub\_jump\_pos & integer \\ \hline
1.4, 2.7.0 &  5 & sub\_jump\_npos & integer\\ \hline
\end{tabular}
\vspace{2mm}
...
Immedate constants are not allowed, and the corresponding format is used for other purposes.
If a constant operand is needed then change the sign of the operand and use add\_jump\_pos. 

\subsubsection{sub\_jump\_overfl}
\label{table:subJumpOverflInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
1.4, 2.7.0 &  6 & sub\_jump\_overfl & integer \\ \hline
1.4, 2.7.0 &  7 & sub\_jump\_noverfl & integer\\ \hline
\end{tabular}
\vspace{2mm}
...
Immedate constants are not allowed, and the corresponding format is used for other purposes.
If a constant operand is needed then change the sign of the operand and use add\_jump\_overfl. 

\subsubsection{sub\_jump\_borrow}
\label{table:subJumpBorrowInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
1.4, 2.7.0 &  8 & sub\_jump\_borrow & integer \\ \hline
1.4, 2.7.0 &  9 & sub\_jump\_nborrow & integer\\ \hline
\end{tabular}
\vspace{2mm}
...
Immedate constants are not allowed, and the corresponding format is used for other purposes.
If a constant operand is needed then change the sign of the operand and use add\_jump\_borrow. 

\subsubsection{sub\_jump}
\label{table:subJumpInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 56 & sub\_jump & integer \\ \hline
\end{tabular}
\vspace{2mm}

Subtract two integer operands and jump unconditionally.

\subsubsection{compare\_jump\_nequal}
\label{table:compareJumpNequalInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 32 & compare\_jump\_nequal & integer and floating point \\ \hline
all & 33 & compare\_jump\_equal  & integer and floating point \\ \hline
\end{tabular}
\vspace{2mm}

Compare two integer or floating point operands and jump if they are not equal.

The destination operand will be equal to the first source operand.
\vspace{2mm}

Two floating point NAN operands will be treated as not equal, even if they are identical.

0.0 and -0.0 are treated as equal.

\subsubsection{compare\_jump\_sbelow}
\label{table:compareJumpSbelowInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 34 & compare\_jump\_sbelow & integer and floating point \\ \hline
all & 35 & compare\_jump\_saboveeq  & integer and floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
compare\_jump\_sbelow will jump and compare\_jump\_saboveeq will not jump if one or both operands are NAN.

\subsubsection{compare\_jump\_sabove}
\label{table:compareJumpSaboveInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 36 & compare\_jump\_sabove & integer and floating point \\ \hline
all & 37 & compare\_jump\_sbeloweq  & integer and floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
compare\_jump\_sabove will jump and compare\_jump\_sbeloweq will not jump if one or both operands are NAN.

\subsubsection{compare\_jump\_ubelow}
\label{table:compareJumpUbelowInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 38 & compare\_jump\_ubelow & integer \\ \hline
all & 39 & compare\_jump\_uaboveeq  & integer \\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{compare\_jump\_uabove}
\label{table:compareJumpUaboveInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{40mm}|p{60mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 40 & compare\_jump\_uabove & integer \\ \hline
all & 41 & compare\_jump\_ubeloweq  & integer \\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{compare\_jump\_absbelow}
\label{table:compareJumpAbsbelowInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 38 & compare\_jump\_absbelow & floating point \\ \hline
all & 39 & compare\_jump\_absaboveeq & floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
The destination operand will be equal to the unchanged first source operand.
\vspace{2mm}

compare\_jump\_absbelow will jump and compare\_jump\_absaboveeq will not jump if one or both operands are NAN.

\subsubsection{compare\_jump\_absabove}
\label{table:compareJumpAbsaboveInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 38 & compare\_jump\_absabove & floating point \\ \hline
all & 39 & compare\_jump\_absbeloweq & floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{compare\_jump\_nfinite}
\label{table:compareJumpNfiniteInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 24 & compare\_jump\_nfinite & floating point \\ \hline
all & 25 & compare\_jump\_finite & floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{shift\_jump\_nzero}
\label{table:shiftJumpNzeroInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 28 & shift\_jump\_nzero & all \\ \hline
all & 29 & shift\_jump\_zero & all \\ \hline
\end{tabular}
\vspace{2mm}

Shift the first source operand by the count of the second source operand, left if positive or right if negative. Jump if the result is not zero.
\vspace{2mm}

The first source operand is treated as an unsigned integer. The second source operand is treated as a signed integer.
\vspace{2mm}

dest = src1 $<<$ src2 if src2 $\geq$ 0
...
\subsubsection{shift\_jump\_carry}
\label{table:shiftJumpCarryInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 30 & shift\_jump\_carry & all \\ \hline
all & 31 & shift\_jump\_ncarry & all \\ \hline
\end{tabular}
\vspace{2mm}

Shift the first source operand by the count of the second source operand, left if positive or right if negative. Jump if the last bit shifted out is 1.
\vspace{2mm}
...
\subsubsection{test\_bit\_jump\_nzero}
\label{table:testBitJumpNzeroInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 26 & test\_bit\_jump\_nzero & all \\ \hline
all & 27 & test\_bit\_jump\_zero & all \\ \hline
\end{tabular}
\vspace{2mm}

Test a single bit in the first source operand as indicated by the second source operand and jump if this bit is 1. The destination is unchanged.
\vspace{2mm}
...
\subsubsection{test\_jump\_nzero}
\label{table:testJumpNzeroInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 42 & test\_jump\_nzero & all \\ \hline
all & 43 & test\_jump\_zero & all \\ \hline
\end{tabular}
\vspace{2mm}

Bitwise test. Jump if at least one of the indicated bits is 1.
\vspace{2mm}
...
\subsubsection{and\_jump\_nzero}
\label{table:andJumpNzeroInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 44 & and\_jump\_nzero & all \\ \hline
all & 45 & and\_jump\_zero & all \\ \hline
\end{tabular}
\vspace{2mm}

Bitwise and. Jump if not zero.
\vspace{2mm}
...
\subsubsection{or\_jump\_nzero}
\label{table:orJumpNzeroInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 46 & or\_jump\_nzero & all \\ \hline
all & 47 & or\_jump\_zero & all \\ \hline
\end{tabular}
\vspace{2mm}

Bitwise or. Jump if not zero.
\vspace{2mm}
...
\subsubsection{xor\_jump\_test\_and}
\label{table:xorJumpTestAndInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{42mm}|p{58mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 48 & xor\_jump\_test\_and & all \\ \hline
all & 49 & xor\_jump\_ntest\_and & all \\ \hline
\end{tabular}
\vspace{2mm}

Toggle bits. Jump if all indicated bits are changed from 1 to 0.
\vspace{2mm}
...
\subsection{Other control transfer instructions}
...
\hline
\bfseries format & \bfseries opcode & \bfseries operands \\ \hline
1.5 C & 58 & relative addres with 16 bit offset \\ \hline
1.5 D &  0 & relative addres with 24 bit offset \\ \hline
2.7.2 C & 58 & relative addres with 32 bit offset \\ \hline
3.0.1 B & 58 & 64 bit absolute address in constant \\ \hline
1.4 B & 58 & 64 bit absolute address in memory operand with 8 bit offset \\ \hline
2.7.0 B & 58 & 64 bit absolute address in memory operand with 32 bit offset \\ \hline
...
\hline
\bfseries format & \bfseries opcode & \bfseries operands \\ \hline
1.5 C & 59 & relative addres with 16 bit offset \\ \hline
1.5 D &  8 & relative addres with 24 bit offset \\ \hline
2.7.2 C & 59 & relative addres with 32 bit offset \\ \hline
3.0.1 B & 59 & 64 bit absolute address in constant \\ \hline
1.4 B & 59 & 64 bit absolute address in memory operand with 8 bit offset \\ \hline
2.7.0 B & 59 & 64 bit absolute address in memory operand with 32 bit offset \\ \hline
...
\hline
\bfseries format & \bfseries opcode & \bfseries operands \\ \hline
1.4 A & 60 & Jump with table of relative addresses  \\ \hline
1.4 A & 61 & Call with table of relative addresses  \\ \hline
\end{tabular}
\vspace{2mm}
...
The table of jump or call addresses is stored in memory as signed offsets relative to an arbitrary reference point, which may be the table address, the code base, or any other reference point. The operand type specifies the size of the table entries. 16-bit and 32-bit table entries must be supported. Other sizes are optional. The use of relative addresses makes the table more compact than if 64-bit absolute addresses were used. Support for a mask is optional.
\vspace{2mm}
...
The table used by the table-based jump and call instructions may be placed in the constant data section (CONST). This makes it possible to use the table base as reference point and it improves security by giving read-only access to the table.
\vspace{2mm}
...
1.5 C & 63 & trap & 0-62 \\ \hline
1.5 C & 63 & filler & 63 \\ \hline
\end{tabular}
\vspace{2mm}
...
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries immediate operand \\ \hline
2.7.3 C & 63 & compare, trap\_uabove & 40 \\ \hline
2.7.3 C & 63 & conditional trap & IM1 = interrupt number, IM2 = OPJ \\ \hline
\end{tabular}
\vspace{2mm}
