...
\hline
\bfseries format & \bfseries opcode & \bfseries operands \\ \hline
2.2.6 & 8.1 & vectors. Optional \\ \hline
\end{tabular}
\vspace{2mm}
...
\hline
\bfseries format & \bfseries opcode & \bfseries operands \\ \hline
2.2.6 & 9.1 & vectors. Optional \\ \hline
\end{tabular}
\vspace{2mm}
...
The length in bytes of the result vector is specifice by a general purpose register in RS.
...
bit 4 = 1: broadcast remaining bits from IM2 into all 32-bit words of RD. 
           Bit 1-7 of IM2 go to bit 1-7 of RD. 
           Bit 8-11 of IM2 go to bit 18-21 of RD. Bit 12-15 of IM2 go to bit 26-29 of RD. \\
...
\hline
\bfseries format & \bfseries opcode & \bfseries operands \\ \hline
2.2.7 & 2.1 & integer vectors. Optional \\ \hline
\end{tabular}
\vspace{2mm}
...
bit 4 = 1: broadcast remaining bits from IM2 into all 32-bit words of RD. 
           Bit 8-11 of IM2 go to bit 18-21 of dest. Bit 12-15 of IM2 go to bit 26-29 of RD. \\
Output bits that are not set by any of these options will be zero. 
If multiple options are specified, the results will be OR'ed.
...
\subsubsection{compare/jump\_equal}
\label{table:compareJumpEqualInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 32 & compare/jump\_equal & integer or floating point \\ \hline
all & 33 & compare/jump\_nequal  & integer or floating point \\ \hline
\end{tabular}
\vspace{2mm}

Compare two integer or floating point operands and jump if they are equal.
...
\subsubsection{compare/jump\_sbelow}
\label{table:compareJumpSbelowInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 34 & compare/jump\_sbelow & integer or floating point \\ \hline
all & 35 & compare/jump\_saboveeq  & integer or floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
compare/jump\_sbelow will jump and compare/jump\_saboveeq will not jump if one or both operands are NAN.

\subsubsection{compare/jump\_sabove}
\label{table:compareJumpSAboveInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 36 & compare/jump\_sabove & integer or floating point \\ \hline
all & 37 & compare/jump\_sbeloweq  & integer or floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
compare/jump\_sabove will jump and compare/jump\_sbeloweq will not jump if one or both operands are NAN.

\subsubsection{compare/jump\_ubelow}
\label{table:compareJumpUBelowInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 38 & compare/jump\_ubelow & integer \\ \hline
all & 39 & compare/jump\_uaboveeq  & integer \\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{compare/jump\_uabove}
\label{table:compareJumpUAboveInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 40 & compare/jump\_uabove & integer \\ \hline
all & 41 & compare/jump\_ubeloweq  & integer \\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{compare/jump\_absbelow}
\label{table:compareJumpAbsBelowInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 38 & compare/jump\_absbelow & floating point \\ \hline
all & 39 & compare/jump\_absaboveeq & floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
compare/jump\_absbelow will jump and compare/jump\_absaboveeq will not jump if one or both operands are NAN.

\subsubsection{compare/jump\_absabove}
\label{table:compareJumpAbsAboveInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 38 & compare/jump\_absabove & floating point \\ \hline
all & 39 & compare/jump\_absbeloweq & floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
\subsubsection{compare/jump\_nfinite}
\label{table:compareJumpNfiniteInstruction}
\begin{tabular}{|p{16mm}|p{12mm}|p{60mm}|p{50mm}|}
\hline
\bfseries format & \bfseries opcode & \bfseries instruction & \bfseries operands \\ \hline
all & 24 & compare/jump\_nfinite & floating point \\ \hline
all & 25 & compare/jump\_finite & floating point \\ \hline
\end{tabular}
\vspace{2mm}
...
int32 compare\_swap(r1, r2, [r3+0x100])
\vspace{2mm}
